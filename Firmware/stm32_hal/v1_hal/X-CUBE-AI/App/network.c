...
#define AI_NETWORK_MODEL_SIGNATURE     "0xbbeeefe6a5e6dcf92187d9d93ef2405d"
...
#define AI_TOOLS_DATE_TIME   "2026-07-21T16:22:55+0530"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 908, 1, 1),
    908, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 20);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 20);
    ...
    nl_0_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    nl_0_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 192);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 192);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 256);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 256);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 768);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 768);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 800);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 800);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 896);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 896);
    return true;
  }
