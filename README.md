...
**1. Dynamic leanring:** The raw data directly feeds into the microcontroller using NanoEdge AI library followed by run On-Device training through an optimal pre-defined model and deploy into the microcontroller 
...
**Workflow**
**On-Device learning:** 
- The microcontroller peripherals of GPIO and I2C get initiated using STM32cube MX, then with help of STM32cube IDE create a HAL layer instruction to read raw data from three axis ax, ay, az of MPU6050
