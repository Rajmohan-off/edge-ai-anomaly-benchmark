...
To support complex neural network inference and hardware abstraction, the main branch has been upgraded to utilize **STM32 HAL, FreeRTOS (optional), and the ST X-CUBE-AI framework**.
